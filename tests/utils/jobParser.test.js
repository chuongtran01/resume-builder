...
const jobParser_1 = require("@utils/jobParser");
describe('jobParser', () => {
    describe('parseJobDescription', () => {
      ...
      `;
            const result = (0, jobParser_1.parseJobDescription)(jobDescription);
      ...
      `;
        ...
        it('should handle empty string', () => {
            const result = (0, jobParser_1.parseJobDescription)('');
            expect(result).toBeDefined();
        ...
        it('should handle null/undefined input gracefully', () => {
            ...
            const result1 = (0, jobParser_1.parseJobDescription)(null);
            expect(result1).toBeDefined();
            expect(result1.keywords).toEqual([]);
            // @ts-expect-error - Testing invalid input
            const result2 = (0, jobParser_1.parseJobDescription)(undefined);
        ...
        it('should handle job description with various formats', () => {
            ...
            for (const format of formats) {
                const result = (0, jobParser_1.parseJobDescription)(format);
                expect(result).toBeDefined();
      ...
      `;
        ...
        - Node.js
      `;
            const result = (0, jobParser_1.parseJobDescription)(longDescription);
            expect(result).toBeDefined();
            expect(result.jobTitle).toBeDefined();
            expect(result.keywords.length).toBeGreaterThan(0);
        });
        it('should extract experience level variations', () => {
            ...
            for (const variation of variations) {
                const result = (0, jobParser_1.parseJobDescription)(variation);
                if (result.experienceLevel) {
                    extractedCount++;
                }
            }
...
//# sourceMappingURL=jobParser.test.js.map