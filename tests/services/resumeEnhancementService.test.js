...
const resumeEnhancementService_1 = require("@services/resumeEnhancementService");
  ...
  `;
    describe('enhanceResume', () => {
        it('should enhance resume and return EnhancementResult', async () => {
            const result = await resumeEnhancementService_1.resumeEnhancementService.enhanceResume(sampleResume, sampleJobDescription);
        ...
        it('should handle resume without summary', async () => {
            ...
            const result = await resumeEnhancementService_1.resumeEnhancementService.enhanceResume(resumeWithoutSummary, sampleJobDescription);
            expect(result).toBeDefined();
            expect(result.enhancedResume).toBeDefined();
        });
        it('should handle resume without skills', async () => {
            ...
            const result = await resumeEnhancementService_1.resumeEnhancementService.enhanceResume(resumeWithoutSkills, sampleJobDescription);
            expect(result).toBeDefined();
            expect(result.enhancedResume).toBeDefined();
        });
        it('should handle empty job description', async () => {
            const result = await resumeEnhancementService_1.resumeEnhancementService.enhanceResume(sampleResume, '');
            expect(result).toBeDefined();
            expect(result.enhancedResume).toBeDefined();
            // Should still return valid result even with empty job description
        });
        it('should respect focus areas option', async () => {
            const result = await resumeEnhancementService_1.resumeEnhancementService.enhanceResume(sampleResume, sampleJobDescription, { focusAreas: ['summary'] });
            expect(result).toBeDefined();
    ...
    describe('rewriteBulletPoints', () => {
        it('should rewrite bullet points with keywords', () => {
            const service = new resumeEnhancementService_1.MockResumeEnhancementService();
            const bulletPoints = [
                'Built scalable web applications',
    ...
    describe('trackChanges', () => {
        it('should track changes between original and enhanced resume', () => {
            ...
            const enhanced = JSON.parse(JSON.stringify(sampleResume));
...
//# sourceMappingURL=resumeEnhancementService.test.js.map