...
describe('GeminiProvider', () => {
    ...
    beforeEach(() => {
        ...
        provider = new gemini_1.GeminiProvider(mockConfig);
    });
    describe('Constructor', () => {
        ...
        it('should use default config values', () => {
            ...
            const p = new gemini_1.GeminiProvider(minimalConfig);
            expect(p).toBeInstanceOf(gemini_1.GeminiProvider);
        });
    });
    ...
    describe('validateResponse', () => {
        ...
        it('should reject invalid ReviewResponse', () => {
            ...
            expect(provider.validateResponse(invalidResponse)).toBe(false);
        });
    ...
    describe('reviewResume', () => {
        ...
        it('should handle empty response', async () => {
            ...
            await expect(provider.reviewResume(request)).rejects.toThrow(provider_types_1.InvalidResponseError);
        });
    ...
    describe('modifyResume', () => {
        it('should require reviewResult', async () => {
            ...
            await expect(provider.modifyResume(request)).rejects.toThrow(provider_types_1.InvalidResponseError);
        });
        it('should call Gemini API and parse response', async () => {
    ...
    describe('Error Handling', () => {
        ...
        it('should handle timeout errors', async () => {
            ...
            const shortTimeoutProvider = new gemini_1.GeminiProvider({
                ...mockConfig,
                timeout: 1, // 1ms timeout
            });
            // Mock a slow response
            mockGenerateContent.mockImplementation(() => new Promise((resolve) => setTimeout(() => resolve({ response: { text: () => '{}' } }), 100)));
            const request = {
                resume: sampleResume,
                jobInfo: sampleJobInfo,
            };
            await expect(shortTimeoutProvider.reviewResume(request)).rejects.toThrow(provider_types_1.TimeoutError);
        });
    });
});
