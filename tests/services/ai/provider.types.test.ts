  ...
  describe('Error Classes', () => {
    describe('AIProviderError', () => {
      it('should create error with provider and code', () => {
        const error = new AIProviderError('Test error', 'gemini', 'TEST_CODE');
      ...
      it('should create error without code', () => {
        const error = new AIProviderError('Test error', 'gemini');
        expect(error.provider).toBe('gemini');
    ...
    describe('RateLimitError', () => {
      it('should create rate limit error with retry after', () => {
        const error = new RateLimitError('Rate limited', 'gemini', 60);
        expect(error).toBeInstanceOf(AIProviderError);
    ...
    describe('InvalidResponseError', () => {
      it('should create invalid response error with response', () => {
        ...
        const error = new InvalidResponseError('Invalid response', 'gemini', response);
        expect(error).toBeInstanceOf(AIProviderError);
    ...
    describe('NetworkError', () => {
      it('should create network error with original error', () => {
        ...
        const error = new NetworkError('Network error', 'gemini', originalError);
        expect(error).toBeInstanceOf(AIProviderError);
    ...
    describe('TimeoutError', () => {
      it('should create timeout error with timeout value', () => {
        const error = new TimeoutError('Request timeout', 'gemini', 30000);
        expect(error).toBeInstanceOf(AIProviderError);
  ...
  describe('Type Definitions', () => {
    ...
    describe('AIProviderConfig', () => {
      ...
      it('should support additional provider-specific options', () => {
        ...
        expect((config as Record<string, unknown>).customOption).toBe('value');
      });
    });
    ...
    describe('EnhancementPrompt', () => {
      ...
      it('should support optional context', () => {
        ...
        expect((prompt.context as Record<string, unknown>).jobTitle).toBe('Software Engineer');
      });
    });
  });
